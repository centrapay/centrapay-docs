import{p as U}from"./chunk-OQCM5LHU.Br36LL40.js";import{Y as y,P as z,aE as j,F as q,q as K,r as Y,s as Z,g as H,c as J,b as Q,_ as p,l as F,t as X,d as tt,G as et,K as at,a6 as rt,k as nt}from"./mermaid.core.DdGjVvOE.js";import{p as it}from"./gitGraph-YCYPL57B.CVHigpoM.js";import{d as O}from"./arc.C0xCt-K5.js";import{o as st}from"./ordinal.BYWQX77i.js";import"./preload-helper.CLcXU_4U.js";import"./_commonjsHelpers.Cpj98o6Y.js";import"./_baseUniq.Cm7PsLAI.js";import"./_basePickBy.BtzHQY7O.js";import"./clone.BLR5JU81.js";import"./init.Gi6I4Gst.js";function ot(t,a){return a<t?-1:a>t?1:a>=t?0:NaN}function lt(t){return t}function ct(){var t=lt,a=ot,m=null,s=y(0),d=y(z),x=y(0);function i(e){var r,l=(e=j(e)).length,c,A,h=0,u=new Array(l),n=new Array(l),v=+s.apply(this,arguments),w=Math.min(z,Math.max(-z,d.apply(this,arguments)-v)),f,T=Math.min(Math.abs(w)/l,x.apply(this,arguments)),$=T*(w<0?-1:1),g;for(r=0;r<l;++r)(g=n[u[r]=r]=+t(e[r],r,e))>0&&(h+=g);for(a!=null?u.sort(function(S,C){return a(n[S],n[C])}):m!=null&&u.sort(function(S,C){return m(e[S],e[C])}),r=0,A=h?(w-l*$)/h:0;r<l;++r,v=f)c=u[r],g=n[c],f=v+(g>0?g*A:0)+$,n[c]={data:e[c],index:r,value:g,startAngle:v,endAngle:f,padAngle:T};return n}return i.value=function(e){return arguments.length?(t=typeof e=="function"?e:y(+e),i):t},i.sortValues=function(e){return arguments.length?(a=e,m=null,i):a},i.sort=function(e){return arguments.length?(m=e,a=null,i):m},i.startAngle=function(e){return arguments.length?(s=typeof e=="function"?e:y(+e),i):s},i.endAngle=function(e){return arguments.length?(d=typeof e=="function"?e:y(+e),i):d},i.padAngle=function(e){return arguments.length?(x=typeof e=="function"?e:y(+e),i):x},i}var R=q.pie,G={sections:new Map,showData:!1,config:R},b=G.sections,P=G.showData,ut=structuredClone(R),pt=p(()=>structuredClone(ut),"getConfig"),dt=p(()=>{b=new Map,P=G.showData,X()},"clear"),gt=p(({label:t,value:a})=>{b.has(t)||(b.set(t,a),F.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ft=p(()=>b,"getSections"),mt=p(t=>{P=t},"setShowData"),ht=p(()=>P,"getShowData"),I={getConfig:pt,clear:dt,setDiagramTitle:K,getDiagramTitle:Y,setAccTitle:Z,getAccTitle:H,setAccDescription:J,getAccDescription:Q,addSection:gt,getSections:ft,setShowData:mt,getShowData:ht},vt=p((t,a)=>{U(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),St={parse:p(async t=>{const a=await it("pie",t);F.debug(a),vt(a,I)},"parse")},yt=p(t=>`
  .pieCircle{

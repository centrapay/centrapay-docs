...
| :-------- | :--------- | :------------------------------------------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 404       | 3          | {% break _ TRANSACTION_NOT_FOUND %}               | A transaction for the provided authorization could not be found on the public blockchain e.g. Cennz.                                                                                                                                                                                                                   |
| 404       | 179        | {% break _ BITCOIN_TRANSACTION_NOT_FOUND %}       | A transaction for the provided authorization could not be found on the bitcoin blockchain.                                                                                                                                                               |
...
| 400       | 176        | {% break _ LEDGER_NOT_ENABLED %}                  | Merchant is not configured with the provided ledger.                                                                                                                                                                                                      |
...
| 400       | 181        | {% break _ INSUFICIENT_PAYMENT %}                 | The transaction was found on the public blockchain but the amount received by Centrapay is less than the total of the payment.                                                                                                                           |
...
| 400       | 195        | {% break _ INVALID_ASSET_ID %}                    | The asset corresponding to the asset id is not supported.                                                                                                                                                                                                 |
| 400       | 196        | {% break _ INVALID_WALLET_ADDRESS %}              | The public wallet address is not the same as the supported wallet address.                                                                                                                                                                                       |

...
| assetId                 | String | Merchant's Centrapay Settlement Asset to receive payments. Optional for `kete.nzd` types, if not supplied then a settlement asset may be created and then assigned.        |

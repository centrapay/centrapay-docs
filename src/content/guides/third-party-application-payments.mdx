...
| authorization | An identifier for your Asset Type which will be used when invoking the [Pay Payment Request API](https://docs.centrapay.com/guides/integrating-third-party-asset/#pay-endpoint) |

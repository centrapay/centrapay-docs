...
4. While the POS continues to poll, the patron [pays the Payment Request](/api/payment-requests#pay-a-payment-request-experimental) via their Centrapay integrated app.

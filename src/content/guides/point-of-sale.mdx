...
- [Initiating refunds](/guides/initiating-refunds) MUST be performed using the `externalRef` or `shortCode` [Payment Request](/api/payment-requests#payment-requests-model) fields.

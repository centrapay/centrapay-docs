...
This information should also be displayed to a consumer when possible. If any line items were purchased by a specific asset, they will be returned on a [Payment Request](https://docs.centrapay.com/api/payment-requests#payment-requests) inside the [Asset Totals](https://docs.centrapay.com/api/payment-requests#asset-total) array.

...
2. If you have a query relating to an invoice or payment, please contact Farmlands on invoice.queries@farmlands.co.nz
3. If you are needing to add a new branch/location please contact your Card Portfolio manager or Card.Specialist@farmlands.co.nz as Farmlands will need to complete the setup of the branch/location within our system prior to this being enabled in the Portal

### Trouble Shooting

<Faq>
  <div>
    <Disclosure client:visible title="What is the address for the portal?">
      https://app.centrapay.com/business
    </Disclosure>
  </div>

  <div>
    <Disclosure client:visible title="I am getting an invalid barcode message in the portal">
  ...
  <div>
    ...
    <div>
    <Disclosure client:visible title="What should I do if the Authorisation is declined?">
    ...
    <div>
    <Disclosure client:visible title="How do I check if a transaction was authorised or where can I see the transaction history?">
    ...
    <div>
    <Disclosure client:visible title="Is there a portal guide that covers additional Trouble Shooting FAQs and that can help with training?">
...
2. If you have a query relating to an invoice or payment, please contact Farmlands at invoice.queries@farmlands.co.nz
3. If you require assistance with the POS integration contact your POS provider.

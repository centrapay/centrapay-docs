...
<FAQ client:visible title="What do we do if the customer cancels their order <u>after</u> we have sent the invoice to Farmlands?">
  Raise a credit note as normal and insert the original authorisation short code on the invoice. This will enable us to identify the original invoice and customer account details.
</FAQ>

<FAQ client:visible title="What do we do if the customer cancels their order <u>before</u> we have sent the invoice to Farmlands?">
...
<FAQ client:visible title="What do we do if we need to amend the value of the order prior to sending the invoice to Farmlands?">
...
<FAQ client:visible title="How long are funds held for on a Customer’s Card?">
...
<FAQ client:visible title="We received a message on the Portal stating the “Barcode is invalid.” What does this mean?">
...
<FAQ client:visible title="How do I manage who has access to the Authorisation Portal?">
  User management and access is at the discretion of the Card Partner.
</FAQ>

<FAQ client:visible title="We have a regular customer. Do we need to obtain an authorisation?">
...
<FAQ client:visible title="How do I release funds held on a customer’s Card?">
...
<FAQ client:visible title="What if the barcode will not scan or is obscured?">
...
<FAQ client:visible title="The authorisation request has prompted us to “Check ID.” The customer is not the actual Cardholder but one of the workers of the Cardholder. Can I accept the Card?">

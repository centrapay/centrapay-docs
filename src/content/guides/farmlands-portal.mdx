...
<FAQ client:visible title="What do we do if the customer cancels their order after we have sent the invoice to Farmlands?">
  Raise a credit note as normal and insert the original authorisation short code on the invoice. This will enable us to identify the original invoice and customer account details.
</FAQ>

<FAQ client:visible title="What do we do if the customer cancels their order before we have sent the invoice to Farmlands?">

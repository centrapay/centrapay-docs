...
- Pre Authorisations MAY omit Line Items when [creating a Payment Request](/api/payment-requests#create-a-payment-request) when completion is performed through existing reconciliation channels.

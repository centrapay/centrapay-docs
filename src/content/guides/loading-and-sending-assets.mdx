...
You can send Assets such as Tokens and Giftcards by calling our [Asset Transfers](/api/asset-transfers#asset-transfer-create) endpoint. You will need to have the recipient’s phone number for `recipientAlias` to identify the reciever.

...
Integrators should continue to poll [get Payment Request](/api/payment-requests#get-a-payment-request)
...
the transaction then the payment request should be [refunded](/api/payment-requests#refund-a-payment-request).

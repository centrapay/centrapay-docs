...
> Note this is assuming the best case scenario, and not accounting for edge cases.
>
> <br />
> You should handle all documented and unknown errors how you see fit and validate
> if a payment is payable before making requests to avoid a bad user experience.

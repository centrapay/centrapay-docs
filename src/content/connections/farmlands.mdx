...
## Solutions
<Grid class='not-prose grid grid-cols-1 gap-6 md:grid-cols-2 pt-4 pb-16'>
  <SolutionCard
    title='1. POS API'
    ...
    linkText='POS Integration Guide'
    linkUrl='/guides/farmlands-pos-integration'
  />
  <SolutionCard
    title='2. Portal'
    ...
    linkText='Portal Guide'
    linkUrl='/guides/farmlands-portal'
  />
</Grid>

...
Exported Farmlands Credit Card information used for importing and updating of a [Patron Code](https://docs.centrapay.com/api/patron-codes).
...
<Properties>
  ...
  <Property name="barcode" type="bignumber">
    Unique 9 digit field to display in barcode format to pay by [Patron Code](https://docs.centrapay.com/api/patron-codes).
  </Property>

...
<Properties>
  ...
  <Property name="merchantId" type="string">
    Centrapay [Merchant](https://docs.centrapay.com/api/merchants) id.
  </Property>

  <Property name="merchantConfigId" type="string">
    Centrapay [Merchant Config](https://docs.centrapay.com/api/merchant-configs) id.
  </Property>
...
<CodePanel title="Pretty Printed Example">
  ```json
  {

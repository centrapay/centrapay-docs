...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/accounts">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/accounts/{accountId}">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="PUT" path="/api/accounts/{accountId}">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="PUT" path="/api/accounts/{accountId}/subscriptions">
      ```bash

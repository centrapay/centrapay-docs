...
A Loyalty Program Membership is a record of a user being onboarded to a Loyalty Program.
...
>
  ...
  <Properties heading="Errors">
    <Error code="403" message="MEMBERSHIP_ALREADY_CREATED">
     Membership has already been created for this Loyalty Program with this idempotency key.
    </Error>
  </Properties>
</Endpoint>
...
Ledgers are a container for tokens. Ledgers contain a balance of the number of tokens the account has from a specific collection. They can be spent and sent in arbitrary amounts.

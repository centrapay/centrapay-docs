...
<Properties>
  ...
  <Property name="type" type="string">
    The type of Promotion. Can be `cashback` or `challenge`. `challenge` gives a set reward one time. `cashback` gives a reward based on the payment amount, which can be completed an unlimited amount of times.
  </Property>
...
>
  ...
  <Properties heading="Errors">
    ...
    <Error code="403" message="MEDIA_UPLOAD_NOT_FOUND">
      The `mediaUploadId` does not exist.
    </Error>
  </Properties>
</Endpoint>

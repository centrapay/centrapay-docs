...
<Properties>
  ...
  <Property name="provider" type="string">
    The integrator that owns the code. This can be used to calculate discounts on [Line Items](/api/payment-requests#line-item). Can be `paypal`, `venmo`, `farmlands` or `centrapay`.
  </Property>

...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/bank-accounts">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/bank-accounts/{bankAccountId}/direct-debit-authorities">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/bank-accounts/{bankAccountId}">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/bank-accounts/{bankAccountId}/balance">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/bank-accounts/{bankAccountId}/verify">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/bank-authorities/{bankAccountId}/verify">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/accounts/{accountId}/bank-accounts">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/bank-authorities">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/bank-authorities">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/bank-authorities/{bankAccountId}">
      ```bash

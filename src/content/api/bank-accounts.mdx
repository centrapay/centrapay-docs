...
and has authority to operate this account.
  ...
  <RequestCodePanel slot="code-examples" filename="bank-accounts-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-accounts-add-direct-debit-authority" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-accounts-get" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-accounts-get-balance" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-accounts-verify" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-authorities-verify" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-accounts-list" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-authorities-list" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-authorities-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-authorities-get" />

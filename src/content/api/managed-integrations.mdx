...
>
  ...
  <RequestCodePanel slot="code-examples" filename="managed-integrations-create-or-update" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="managed-integrations-get" />

...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-account-connection-intents-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="bank-account-connection-intents-authorize" />

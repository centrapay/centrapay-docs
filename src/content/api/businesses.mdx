...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/businesses">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="PUT" path="/api/businesses/{businessId}">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/accounts/{accountId}/business">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/nzbn-search">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/nzbn/{nzbn}">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/businesses/{businessId}/set-onboarding-status">
      ```bash

...
<img src="/asset-lifecycle.png" alt="" style="max-height: 384px;" />
...
>
  ...
  <Properties>
    ...
    <Error code="403" message="QUOTA_EXCEEDED">
      The transfer exceeds one or more spend quota limits. See [Quota Error Response](/api/quotas#quota-error-response).
    </Error>

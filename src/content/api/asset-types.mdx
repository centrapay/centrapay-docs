...
| centrapay.ledger | Centrapay Ledgers                                   |                                  | `NZD`                         | ⚡️ 🧪     |
 ...
 * 🚫 : **Restricted Asset** -- Cannot be used to pay for "restricted" [Line Items](/api/payment-requests#line-item-model).
 * 💸 : **Supports Quick Pay** -- Can be used to quick pay a [Payment Request](/api/payment-requests).
 * 💼 : **Requires Tax Number** -- [Tax Number](/api/businesses#tax-number-model) must exist on the Merchant's Business to transact this asset type.

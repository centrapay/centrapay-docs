...
>
  ...
  <RequestCodePanel slot="code-examples" filename="merchants-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="merchants-get" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="merchants-list-by-accountId" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="merchants-update" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="merchants-set-onboarding-status" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="merchants-search" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="merchants-list" />

...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-get" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-get-by-short-code" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-get-by-patron-code" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-pay" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-refund" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-void" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-release" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-confirm" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-activities-list" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-list-payment-activities" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-conditions-accept" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="payment-requests-conditions-decline" />

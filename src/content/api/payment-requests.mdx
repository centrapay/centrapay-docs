...
<Properties>
  ...
  <Property name="redirectCancelUrl" type="string" experimental>
  ...
  <Property name="redirectPaidUrl" type="string" experimental>
...
<Properties>
  ...
  <Property name="qty" type="bignumber" required>
    The product quantity (eg. item count, weight, volume etc).
  </Property>
  <Property name="price" type="bignumber" required>
...
>
  ...
  This endpoint allows you to list [Payment Requests](#payment-request-model) that match the given external reference.

...
>
  ...
  <RequestCodePanel slot="code-examples" filename="wallets-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="wallets-list" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="wallets-list-transactions" />

...
>
  ...
  <RequestCodePanel slot="code-examples" filename="legacy-payment-requests-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="legacy-payment-requests-get" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="legacy-payment-requests-pay" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="legacy-payment-requests-cancel" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="legacy-payment-requests-void" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="legacy-payment-requests-refund" />

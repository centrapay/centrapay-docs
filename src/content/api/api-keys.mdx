...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="POST" path="/api/accounts/{accountId}/api-keys">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="GET" path="/api/accounts/{accountId}/api-keys">
      ```bash
...
>
  ...
  <CodeGroup slot="code-examples">
    <CodePanel title="Request" method="PUT" path="/api/accounts/{accountId}/api-keys/{apiKeyName}">
    ```bash [Request]

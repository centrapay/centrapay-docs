...
>
  ...
  <RequestCodePanel slot="code-examples" filename="api-keys-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="api-keys-list" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="api-keys-update" />

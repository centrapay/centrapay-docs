...
|              name              |                                    description                                     |
| :----------------------------- | :--------------------------------------------------------------------------------- |
| force-condition-check-photo-id | The Payment Request will have a required [Merchant Condition](/api/payment-requests#merchant-condition) to check photo id. |
...
>
  ...
  This endpoint allows you to create a Patron Code. You can find payment request information attached to a Patron Code by [polling for the Payment Request](/api/payment-requests#patron-code) using the transacting APIs.

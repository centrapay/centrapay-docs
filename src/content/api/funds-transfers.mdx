...
>
  ...
  <Properties heading="Errors">
    ...
    <Error code="403" message="QUOTA_EXCEEDED">
      The topup exceeds one or more top up quota limits. See [Quota Error Response](/api/quotas#errors).
    </Error>

    <Error code="403" message="DIRECT_DEBIT_NOT_AUTHORIZED">
      Bank account requires authorization for top up. See bank accounts [direct debit endpoint](/api/bank-accounts#add-direct-debit-authority-to-a-bank-account).
    </Error>
  ...
  <RequestCodePanel slot="code-examples" filename="topups-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="topups-get" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="topups-list" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="topups-list-by-accountId" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="withdrawals-create" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="withdrawals-get" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="withdrawals-list-by-accountId" />
...
>
  ...
  <RequestCodePanel slot="code-examples" filename="funds-transfers-abort" />
